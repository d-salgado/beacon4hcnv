-- FUNCTION: v20.query_data_response(text, integer, integer, integer, integer, integer, integer, character varying, text, text, text, text, text)

-- DROP FUNCTION v20.query_data_response(text, integer, integer, integer, integer, integer, integer, character varying, text, text, text, text, text);

CREATE OR REPLACE FUNCTION v20.query_data_response(
	_variant_type text,
	_start integer,
	_start_min integer,
	_start_max integer,
...
BEGIN
	...
	_query = '
		SELECT 
			...
			bdat.dataset_id
		FROM v20.beacon_data_table bdat
		INNER JOIN v20.beacon_dataset_table bdataset ON bdataset.id=bdat.dataset_id
		WHERE';
...
ALTER FUNCTION v20.query_data_response(text, integer, integer, integer, integer, integer, integer, character varying, text, text, text, text, text)
